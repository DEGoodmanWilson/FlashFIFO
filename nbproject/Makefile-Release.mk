...
${OBJECTDIR}/Test/FIFO_read_test.o: Test/FIFO_read_test.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -I. -I/usr/local/share/CppUTest/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/Test/FIFO_read_test.o Test/FIFO_read_test.cpp

${OBJECTDIR}/Test/FIFO_write_test.o: Test/FIFO_write_test.cpp 
	${MKDIR} -p ${OBJECTDIR}/Test
	${RM} $@.d
	$(COMPILE.cc) -O2 -I. -I/usr/local/share/CppUTest/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/Test/FIFO_write_test.o Test/FIFO_write_test.cpp

${OBJECTDIR}/Test/flash_port_mock.o: Test/flash_port_mock.c 
	${MKDIR} -p ${OBJECTDIR}/Test
	${RM} $@.d
	$(COMPILE.c) -O2 -I. -I/usr/local/share/CppUTest/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/Test/flash_port_mock.o Test/flash_port_mock.c

${OBJECTDIR}/Test/test_main.o: Test/test_main.cpp 
	${MKDIR} -p ${OBJECTDIR}/Test
	${RM} $@.d
	$(COMPILE.cc) -O2 -I. -I/usr/local/share/CppUTest/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/Test/test_main.o Test/test_main.cpp
